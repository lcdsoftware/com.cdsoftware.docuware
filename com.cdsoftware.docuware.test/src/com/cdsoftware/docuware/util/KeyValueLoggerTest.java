...
import static com.cdsoftware.docuware.test.util.RandomTestUtil.*;
import static com.cdsoftware.docuware.test.util.ReflectionTestUtil.*;
...
class KeyValueLoggerTest {
	...
	void shouldPrintClassFromClass() {
		...
		verifyStringLog(Level.INFO, "class=\"com.cdsoftware.docuware.util.KeyValueLogger\"");
	}
	...
	void shouldPrintPackageFromClass() {
		...
		verifyStringLog(Level.INFO, "package=\"com.cdsoftware.docuware.util\"");
	}
