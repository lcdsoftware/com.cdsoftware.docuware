...
call mvn validate -Didempiere.target=com.cdsoftware.docuware.p2.targetplatform %DEBUG_MODE%
call mvn verify -Didempiere.target=com.cdsoftware.docuware.p2.targetplatform %DEBUG_MODE%
