...
- New callout
    * Name: CName
    * Package: com.cdsoftware.docuware.callout
    * Example: com.cdsoftware.docuware.callout.CStringFormat

- New process
    * Name: PName
    * Package: com.cdsoftware.docuware.process
    * Example: com.cdsoftware.docuware.process.PGenerateWithholding

- New form
    * Name: FName
    * Package: com.cdsoftware.docuware.form
    * Example: com.cdsoftware.docuware.form.FMultiPayment

- New event
    * Name: EName
    * Package: com.cdsoftware.docuware.event
    * Example: com.cdsoftware.docuware.event.EAfterCompleteInvoice

- New model (extends class X)
    * Name: MName
    * Package: com.cdsoftware.docuware.model
    * Example: com.cdsoftware.docuware.model.MTableExample
...
- New callout
    * Create callout in package `com.cdsoftware.docuware.callout`, extends from `CustomCallout`
    * Annotate it with the `@Callout` annotation at class level

- New process
    * Create process in package `com.cdsoftware.docuware.process`, extends from `CustomProcess`
    * Annotate it with the `@Process` annotation at class level

- New form
    * Create form in package `com.cdsoftware.docuware.form`, extends from `CustomForm`
    * Annotate it with the `@Form` annotation at class level

- New event
    * Create event in package `com.cdsoftware.docuware.event`, extends from `CustomEvent`
    * Annotate it with the `@EventTopicDelegate` annotation at class level

- New model (extends form class X)
    * Create model in package `com.cdsoftware.docuware.model`, extends class `X`. Example: `X_TL_TableExample -> MTableExample`
